	...
	'components' => array(
        'assetManager' => array(
            ...
            'basePath' => ENV_DEV
                ...
                : 'gs://gae-yii.appspot.com/assets-bucket', // basePath for production version
            ...
            'baseUrl' => ENV_DEV
                ...
                : 'http://commondatastorage.googleapis.com/gae-yii.appspot.com/assets-bucket' // baseUrl for production App Engine
        ),
        'request' => array(
            'baseUrl' => '/',
            'scriptUrl' => '/',
